...
const Hero = ({ heroData, heroCount, setHeroCount }) => {
  return (
    <div className='w-full md:w-[40%] h-[100%] relative '>
      <div className="absolute text-white text-[30px] md:text-[40px] lg:text-[55px]
left-0 top-[10%] md:top-[90px] lg:top-[130px]">
         <p>{heroData.text}</p>
        <p>{heroData.text2}</p>
      </div>
      <div className='absolute md:top-[400px] lg:top-[500px] top-[75%] left-0 flex items-center justify-center gap-[10px]  '>
