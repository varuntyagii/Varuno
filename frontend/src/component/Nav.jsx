...
//         {/* Desktop Navigation Links */}
//         <div className="hidden md:flex space-x-10 mr-11">
...
//             {/* {/* <IoSearch className="w-8 h-8 cursor-pointer text-gray-700 hover:text-blue-600 transition-colors" onClick={() => { setShowSearch(!showSearch) }} /> */}
//             {/* <div className="w-8 h-8 cursor-pointer text-gray-700 hover:text-blue-600 transition-colors" onClick={() => { setShowSearch(!showSearch) }}>
//                 {(showSearch? <IoSearch/> : <IoSearchCircle />
//                 )}
//                 </div> */}
...
//   {/* Search Icon */}
//   <CiSearch
//     className={`absolute left-3  top-1/2 transform -translate-y-1/2 text-gray-500 w-6 h-6 transition-colors duration-200 placeholder:hi ${
//       isSearchFocused || search ? "hidden" : "block"
//     }`}
...
//    className="w-full h-12 pl-12 pr-12 rounded-full
// bg-white
// border border-black
...
//     onMouseDown={(e) => e.preventDefault()}
//     onClick={handleSearch}
//     className={`absolute right-3 top-1/2 transform -translate-y-1/2 w-7 h-7 flex items-center justify-center bg-indigo-500 rounded-full text-white shadow-md hover:bg-indigo-600 transition-all duration-200 ${
//       isSearchFocused || search ? "opacity-100" : "opacity-0"
//     }`}
//   >
//     <FaSearch className="w-4 h-4" />
//   </button>
...
//                 />
//               </div>
//               <p className='absolute w-[18px] h-[18x] items-center justify-center bg-black px-[5px] py-[2px] text-white rounded-full text-[9px] top-[-7px] right-[-14px] '>{getCartCount()}</p>
//             </div>
